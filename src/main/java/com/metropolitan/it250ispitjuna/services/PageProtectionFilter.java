 ...
 */
package com.metropolitan.it250ispitjuna.services;


import com.metropolitan.it250ispitjuna.data.Role;
import com.metropolitan.it250ispitjuna.entities.Korisnik;
import com.metropolitan.it250ispitjuna.pages.Index;
import com.metropolitan.it250ispitjuna.pages.Login;
...
public class PageProtectionFilter implements ComponentRequestFilter {
    ...
    private boolean isAuthenticated() throws IOException {
        ...
        if (user != null) {
            if (user.getKorisnikRola() == Role.ADMIN || user.getKorisnikRola() == Role.KORISNIK) {
                return true;
            }
        }
        return false;
    ...
    private boolean isAuthorised(RolesAllowed rolesAllowed) throws IOException {
        ...
        if (rolesAllowed == null) {
            ...
            Korisnik user = sessionStateManager.getIfExists(Korisnik.class);
            Role rola = user.getKorisnikRola();
